...
ifdef::vmware[]
VMware datastore is set up differently.
VMware Datastores can be thought of as LUNs, which belong to a datastore cluster.
Uses Storage VMotion to move those workloads around.
