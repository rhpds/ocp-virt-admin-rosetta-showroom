...
==== 5.4 Edit the deployment to use a specific node selector (place it on a node where at least 1 vm is running)
...
==== 5.7 Edit the kubedescheduler cluster resource to set the deschedulingIntervalSeconds to a lower value for testing purposes.
[source,bash]
----
