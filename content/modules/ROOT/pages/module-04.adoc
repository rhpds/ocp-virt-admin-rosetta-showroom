...
image::exercise6/04-image-affinity01.png[title="Node Affinity Navigation", link=self, window=blank, width=100%]


[start=8]
. Now navigate to Scheduling → Affinity rules
image::exercise6/04-image-affinity02.png[title="Node Affinity add rule", link=self, window=blank, width=100%]
...
image::exercise6/04-image-affinity03.png[title="Node Affinity Rule", link=self, window=blank, width=100%]
