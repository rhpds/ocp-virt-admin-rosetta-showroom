...
NOTE: Affinity and Anti-Affinity are very similar to VMware Adaptive Resource Scheduling and Rebalancing.
...
node-affinity-vm   30m   Running   10.233.0.46   worker-cluster-t96sv-3   True
----
