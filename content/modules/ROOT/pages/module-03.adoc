...
+ 
. Navigate back to the *Console* tab, select *Serial console* from the drop down. If necessary, click the blue *Connect* button.
...
+
. The new NIC is now available for use (e.g. *enp2s0*, although it mayve have a different name in your environment).
