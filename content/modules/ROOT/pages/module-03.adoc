...
****
VMware admins typically address requests for hot-add resources through the vCenter UI if they are being done manually.
The Aria suite, also formerly known as vRealize Insights (VRI) and vRealize Automation (VRA), and/or other 3rd party Capacity Management software is used to manage the hot-add and hot-removal of resources in an automated fashion.
****
endif::[]
...
. Once the virtual machine is *Running*, click on the *Console* tab. If necessary, click the blue *Connect* button.
...
+
The model should be *virtio*, and the *Network* should be *default/east-west-nad* from the drop down.
